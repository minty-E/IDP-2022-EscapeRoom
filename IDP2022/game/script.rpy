...
label start:
    ...
    label emailScene:
        ...
        scene bg bedroom
        with vpunch
        mc "Odyssey7 sent me this?!{w} No way."
        # what email says
    ...
    label introAct:
        ...
        mc "Odyssey7 never gave me any instructions as to where to go..."
    ...
    label act1:
        ...
        "This room has mirrors in it and a ray of light shooting at one of the mirrors."
...
label act2puzzle2:
    ...
    g "If you're here you must be looking for a special ingredient."
